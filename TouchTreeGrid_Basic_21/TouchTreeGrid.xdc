            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "\r",
                        "        // Use categStyle if exists, else apply detail row style to category row\r",
                        "        if (categData[i].categStyle && categData[i].categStyle > '') {styleStr = categData[i].categStyle;}\r",
                        "        else if (categData[i].style) {styleStr = categData[i].style;}\r",
                        "        else {styleStr = '';}\r",
                        "\r",
                        "        // Substitute user-defined renderer string from Columns array if defined\r",
                        "        rendStr = ((!categData[i].renderer) ? categData[i].dataIndex : '[' + categData[i].renderer + ']');\r",
                        "\r",
                        "        if (i===indentCol) {     \r",
                        "            // Subtract percentage width based on level             \r",
                        "            shellArr.push('<p class=\"touchtreegrid-list-categ-cell\" style=\"' +\r",
            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "var categArrSize = me.getCategItemTpl().length-1;\r",
                        "\r",
                        "var tpl;\r",
                        "if (!simpleList) {\r",
                        "\r",
                        ...
                        "        else {styleStr = '';}        \r",
                        "\r",
                        "        headerTplArr.push('<p class=\"touchtreegrid-header-cell' +\r",
            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "    if (c===colIndex) {\r",
                        "        // Save Original styles and update with sorted styles\r",
