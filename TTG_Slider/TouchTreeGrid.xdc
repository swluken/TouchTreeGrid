            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "var styleStr = '', rendStr='', cssStr='', idxStr = '';\r",
                        ...
                        "    prefixArr = ['<div' + categStyle + categCss + '>'];\r",
                        "\r",
                        "if (parseInt(indent) > 0) {\r",
                        "    prefixArr.push('<div align=\"left\" style=\"width:{[(values.depth-1)*'+indent+']}%;\"></div>');  // 3% per depth starting at 0% \r",
                        "}\r",
                        "if (parseInt(arrowWid) > 0) {\r",
                        "    prefixArr = prefixArr.concat([    \r",
                        "    '<div align=\"left\" style=\"width:'+arrowWid+'%;min-width:'+arrowWid+'%;max-width:'+arrowWid+'%;white-space: nowrap;overflow:hidden;text-overflow:ellipsis;\">', \r",
                        "    '<span class=\"touchtreegrid-details-img ',\r",
                        "    '<tpl if=\"this.isExpanded(values)\">',   \r",
                        "    'touchtreegrid-details-img-open' ,\r",
                        "    '<tpl else>',  \r",
                        "    'touchtreegrid-details-img-close' ,\r",
                        "    '</tpl>',\r",
                        "    '\"</span>',\r",
                        "    '</div>'\r",
                        "    ]);\r",
                        ...
                        "        idxStr = ((!data[i].addDataIndexToDiv) ? '' : ' dataIndex=\"' + data[i].dataIndex + '\"');        \r",
                        "\r",
                        "        if (i===indentCol) {    \r",
                        "            // Subtract percentage width based on level          \r",
                        "            shellArr.push('<div class=\"touchtreegrid-list-categ-cell ' + cssStr + '\" style=\"' +\r",
                        ...
                        "            styleStr + '\"' + idxStr + ' >{' + rendStr + '}</div>');                       \r",
                        "        } else {           \r",
                        "            shellArr.push('<div class=\"touchtreegrid-list-categ-cell \" style=\"' +\r",
                        ...
                        "        } else {           \r",
                        "            shellArr.push('<div class=\"touchtreegrid-list-categ-cell ' + cssStr + '\" style=\"' +\r",
                        "            'min-width:' + categData[i].width + ' !important;' + \r",
                        "            'max-width:' + categData[i].width + ' !important;' + \r",
                        "            'width:' + categData[i].width + ' !important;' + \r",
                        "            styleStr + '\"' + idxStr + ' >{' + rendStr + '}</div>');\r",
                        "        }  \r",
                        "    }\r",
                        "\r",
                        ...
                        "    detailArr = ['<div' + contentStyle + contentCss + '>'];  \r",
                        "    if (parseInt(indent) > 0) {\r",
                        "        detailArr.push('<div align=\"left\" style=\"width:{[(values.depth-1)*'+indent+']}%;\"></div>');    // 3% per depth starting at 0%         \r",
                        "    }\r",
                        "    if (parseInt(arrowWid) > 0) {\r",
                        "        detailArr.push('<div align=\"left\" style=\"width:'+arrowWid+'%;min-width:'+arrowWid+'%;max-width:'+arrowWid+'%;white-space: nowrap;overflow:hidden;text-overflow:ellipsis;\">&nbsp;</div>');\r",
                        "    }\r",
                        "\r",
                        ...
                        "\r",
                        "        // Add dataIndex attribute to this DIV if requested in Columns array (for purposes of trapping cell tap)\r",
                        "        idxStr = ((!data[j].addDataIndexToDiv) ? '' : ' dataIndex=\"' + data[j].dataIndex + '\"');\r",
                        "\r",
                        "        cssStr = (Ext.isEmpty(data[j].css)) ? '' : data[j].css;        \r",
                        "\r",
                        "        if (j===indentCol) {     \r",
                        "            // Subtract percentage width based on level\r",
                        "            detailArr.push('<div class=\"touchtreegrid-list-content-cell ' + cssStr + '\" style=\"' +\r",
                        ...
                        "        cssStr = (Ext.isEmpty(data[j].css)) ? '' : data[j].css;        \r",
                        "\r",
                        "        detailArr.push('<div class=\"touchtreegrid-simplelist-cell ' + cssStr + '\" style=\"' +\r",
                        "        'min-width:' + data[j].width + ' !important;' + \r",
                        "        'max-width:' + data[j].width + ' !important;' + \r",
                        "        'width:' + data[j].width + ' !important;' + \r",
                        "        (Ext.isEmpty(data[j].style) ? '' : data[j].style) + '\" ' + idxStr +\r",
            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "        else {cssStr = '';}        \r",
                        "\r",
                        "        headerTplArr.push('<div class=\"touchtreegrid-header-cell ' + cssStr + \r",
                        ...
                        "        styleStr + '\" dataIndex=\"'+data[j].dataIndex+'\">' + data[j].header + '</div>');               \r",
                        "    }\r",
