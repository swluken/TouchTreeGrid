            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "}\r",
                        "\r",
                        "if (categ==='') {   // Use default if not provided by user\r",
                        "    var shellArr = \r",
                        "    [\r",
            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "\r",
                        "if (node.isLeaf()) {\r",
                        "    this.fireEvent('leafitemtap', list, index, target, record, e);\r",
                        "\r",
                        "} else {\r",
                        "    this.fireEvent('itemtap', this, list, index, target, record, e);  \r",
                        "\r",
            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        "var me = this;\r",
                        "\r",
                        "var img = this.getLandscapeIcon();\r",
                        "\r",
                        "if (this.getIncludeFooter()) {\r",
                        "    Ext.apply(config, {\r",
                        "        docked : 'bottom',\r",
                        "        cls    : 'touchtreegrid-footer',\r",
            ...
            },
            {
                ...
                "userConfig": {
                    ...
                    "implHandler": [
                        ...
                        "        else {styleStr = '';}        \r",
                        "\r",
                        "        headerTplArr.push('<p style=\"min-width:' + data[j].width +\r",
                        "        ';white-space: nowrap;overflow:hidden;text-overflow:clip;' +\r",
                        "        styleStr + '\" >' + data[j].header + '</p>');\r",
                        "    }\r",
                        "    headerTplArr.push('</div>');  \r",
                        "\r",
                        "    // Wrap with spaceer to accomodate for disclosure icon(lines up columns better)\r",
                        "    var headerTplArr2 = [];\r",
                        "    if (disclose) {\r",
                        ...
                        "\r",
                        "\r",
                        "if (me.getApplyDefaultCollapseLevel() && !skipApplyDefaultCollapseLevel) {\r",
                        ...
                        "}\r",
                        "\r",
                        "if (me.getIncludeFooter() && me.getIncludeFooterLevels()) {\r",
