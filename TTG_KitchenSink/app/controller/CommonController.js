...
Ext.define('TouchTreeGrid.controller.CommonController', {
    ...
    onMenuOptListSelect: function(dataview, record, eOpts) {
        ...
        if (text === 'Accordion') {
            ...
            me.getMenuconthelppanel().setHtml('');

            Ext.Ajax.request({
                url: './resources/html/OtherExamples.html',
                method: 'GET',
                callback: function(options, success, response) {
                    commonController.getOtherExamples().setHtml(response.responseText );
                }
            });
        }
    ...
    showHelp: function(gridcont, myWidth, close, htmlUpdated) {
